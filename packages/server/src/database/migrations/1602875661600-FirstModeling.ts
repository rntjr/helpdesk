...
export class FirstModeling1602875661600 implements MigrationInterface {
  name = `FirstModeling1602875661600`
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "Common"."Pessoa" ("id" SERIAL NOT NULL, "nome" character varying NOT NULL, "fantasia" character varying NOT NULL, "cgc" character varying NOT NULL, "aniversario" TIMESTAMP NOT NULL, "enderecoId" integer NOT NULL, CONSTRAINT "UQ_995fbd128bf24b1471332421f37" UNIQUE ("cgc"), CONSTRAINT "PK_4093dac2522e35757bfa1beef27" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "Core"."AcessoGrupoPermissao" ("id" SERIAL NOT NULL, "isMenu" boolean NOT NULL DEFAULT false, "isAcesso" boolean NOT NULL DEFAULT false, "isSalvar" boolean NOT NULL DEFAULT false, "isEditar" boolean NOT NULL DEFAULT false, "isDeletar" boolean NOT NULL DEFAULT false, "telasId" integer NOT NULL, "grupoPermissaoId" integer NOT NULL, CONSTRAINT "PK_3b6892e5a8a61b51ae820c2ef0d" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "Core"."UsuariosGrupoPermissao" ("id" SERIAL NOT NULL, "usuarioId" integer NOT NULL, "permissaoId" integer NOT NULL, CONSTRAINT "PK_c8f4ff5c191bef27e900e5c08fc" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "HelpDesk"."Atribuidos" ("id" SERIAL NOT NULL, "tarefasId" integer NOT NULL, "usuarioId" integer NOT NULL, CONSTRAINT "PK_f327496cdaad3a3a67fc22d207c" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "HelpDesk"."ChecklistItem" ("id" SERIAL NOT NULL, "nome" character varying NOT NULL, "descricao" character varying NOT NULL, "isFechado" boolean NOT NULL DEFAULT false, "checkListId" integer NOT NULL, CONSTRAINT "PK_1ef673313edf5808f58fb401556" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "HelpDesk"."Checklist" ("id" SERIAL NOT NULL, "titulo" character varying NOT NULL, "descricao" character varying NOT NULL, "tarefasId" integer NOT NULL, CONSTRAINT "PK_cdc4ddbf77ccd3a1355c75f63d1" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "HelpDesk"."Revisores" ("id" SERIAL NOT NULL, "tarefasId" integer NOT NULL, "usuarioId" integer NOT NULL, CONSTRAINT "PK_1e352243b270f24cb78ee5e5c74" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "HelpDesk"."Tarefas" ("id" SERIAL NOT NULL, "abertura" TIMESTAMP NOT NULL, "classe" integer NOT NULL, "tipo" integer NOT NULL, "prioridade" integer NOT NULL, "titulo" character varying NOT NULL, "descricao" character varying NOT NULL, "autorId" integer, "statusId" integer, CONSTRAINT "PK_c14bc6faaf626eaba99e6263195" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "HelpDesk"."Quadros" ("id" SERIAL NOT NULL, "nome" character varying NOT NULL, "descricao" character varying NOT NULL, CONSTRAINT "PK_985fd65cec12c48986a3eac51c5" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "HelpDesk"."ColunaQuadro" ("id" SERIAL NOT NULL, "nome" character varying NOT NULL, "descricao" character varying NOT NULL, "quadrosId" integer NOT NULL, CONSTRAINT "PK_816a45e68a90569c33eebb87188" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "HelpDesk"."Cartao" ("id" SERIAL NOT NULL, "sequencia" integer NOT NULL, "titulo" character varying NOT NULL, "descricao" character varying NOT NULL, "colunaQuadroId" integer, "tarefasId" integer, CONSTRAINT "PK_b22178ee731b64be053408ec2f5" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
